...
def parse_args():
    ...
    parser.add_argument('--basal', '-b', dest='basal', required=False, help='Select this option to use a default basal filter of 3.6 percent or use as basal filter IGHV clone with the highest representation in a polyclonal sample if samples containing "policlonal" in sample name are given. If this argument is not given there will be no filters applied.', action='store_true')
